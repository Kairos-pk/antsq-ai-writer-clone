  ...
  return (
    <section className="bg-light-pink py-20 lg:py-[120px]">
      <div className="container">
        <h2 className="text-center text-[40px] font-bold text-dark-gray mb-12">
          Pricing
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 items-stretch">
          {pricingPlans.map((plan, index) => (
            <div key={index} className="bg-light-pink border-2 border-primary-red rounded-[10px] shadow-[0_4px_12px_rgba(0,0,0,0.1)] p-5 flex flex-col items-center">
              <div className="bg-primary-red text-white py-2.5 px-5 rounded-[5px]">
                <h3 className="text-2xl font-bold text-center">{plan.name}</h3>
              </div>

              <div className="my-5 h-[250px] flex items-center justify-center">
                <Image
                  src={plan.imageSrc}
                  alt={plan.imageAlt}
              ...
              <div className="bg-primary-red text-white py-2.5 px-8 rounded-[5px] flex justify-center items-end gap-1">
              ...
              <Link
                ...
                className="bg-primary-red text-white rounded-[5px] py-3 px-6 font-semibold text-center mt-auto hover:opacity-90 transition-opacity"
              >
                Signup Now
              </Link>
            </div>
