      ...
      <div className="mx-auto max-w-6xl px-4">
        <div className="grid grid-cols-1 items-center gap-16 lg:grid-cols-2 lg:gap-24">
          <div className="text-center lg:text-left">
            <h2 className="text-3xl font-bold text-[#2C2C2C] lg:text-4xl">
              Antsq.ai helps
            </h2>
            <h2 className="mt-1 text-4xl font-bold text-[#B22222] lg:text-5xl">
              Business Owners
            </h2>
            <p className="mt-6 text-base leading-relaxed text-[#666666]">
            ...
            <a
              ...
              className="mt-8 inline-flex items-center justify-center rounded-full bg-[#B22222] px-8 py-4 text-base font-medium text-white shadow-[0_4px_12px_rgba(0,0,0,0.15)] transition-transform hover:scale-105"
            >
              Get Started
          ...
          <div className="relative flex items-center justify-center">
            <Image
              src="https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/object/public/test-clones/1ad0bc08-9d6f-4ba4-a0c3-2be1b684f3ee-antsq-com/assets/images/BG-copy-2-6.png"
              alt="Decorative background shape"
              width={600}
              height={600}
              className="absolute inset-0 z-0 m-auto h-full w-full object-contain"
            />
            <div className="relative z-10 rounded-3xl bg-white p-6 shadow-[0_4px_12px_rgba(0,0,0,0.1)] lg:p-10">
              <Image
